...
fun AEPTextComposableTestPreviews() {
    Column(
        ...
        // Font variations
        AEPTextComposable(content = "Large Text", font = AEPText.Font(size = 24))
        AEPTextComposable(content = "Small Text", font = AEPText.Font(size = 10))
        AEPTextComposable(content = "Bold Text", font = AEPText.Font(weight = "bold"))
        AEPTextComposable(content = "Italic Text", font = AEPText.Font(style = listOf("italic")))
        AEPTextComposable(content = "Bold Italic Text", font = AEPText.Font(weight = "bold", style =  listOf("italic")))
        ...
        AEPTextComposable(
            ...
            clr = "#800080",
            align = "center",
            font = AEPText.Font(size = 18, weight = "bold", style = listOf("italic"))
        )
        ...
        // Extreme font sizes
        AEPTextComposable(content = "Tiny Text", font = AEPText.Font(size = 1))
        AEPTextComposable(content = "Huge Text", font = AEPText.Font(size = 100))
    }
}